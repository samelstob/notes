...
* "Customer collaboration is a founding principal of agile.  The customers we
  work with, by and large, value estimates.  They use them for legitimate
business planning purposes."
* "I thought there were some unexamined assumptions behind no estimates"
* "In the early days of agile some people were justifying it on a false
  premise; that it's impossible to get good requirements.  I disagreed with that."
  - It *is* impossible to get *perfect* requirements
  - It *is* impossible to know *all* the requirements up front
  - It *is* impossible to get good requirements if you don't have well developed
...
don't have.  As an empirical observation we often get bad requirements
  - "I was enthusiastic about the agile practices but not the rationale being
    used at the time to support those.  Fast forward 10 years and we see
...
* "The idea that estimates and forecasts are different doesn't understand what
  ...
  - Not all estimates are about the future - if I go out and estimate the size
    of a crowd at some political event or I estimate the number of square
feet in an existing house there is no forecasting there it's purely estimating
...
understanding of what the words mean.
  - "The fact that someone presents best case, worst case, expected case
    doesn't mean that actually had any skill going in to those.  They can
still be sticking their finger in the air and applying their gut feel.  At
that level we are still really talking about guessing."
...
* "We have a tendency in software on all sides of any issue to compare
  poorly-informed unskilled application of the point of view that we don't
like with well-informed competent application of the point of view that we do
like
  - This is a fallacious comparison
  - What possibilities do we open up when we have competency in estimation.
    What possibilities do we open up when we have competency in an
...
primary skill areas and those secondary skill areas.
  - Some technical people tend to think of their necessary areas of expertise as
...
have to choose.  That's an important planning function of any business.*
  - Before the project even starts there is a need to come up with an estimate
    for the project.  The business has a legitmate need to come up with an
...
* A lot of organisations have ineffective commitment processes.
  ...
  - Most large mature organisations have some kind of defined stage-gate
    process which if it's used well can be supportive of effective estimation and
...
* Coarse grained decision making
  ...
  - How many people should we put on the project
...
* Now the role of estimation is more inward looking.  It (the estimation) is
  for the team to manage itself.  It's for the team to assess how it's
progress is going and whether the progress is going according to plan.
...
* If there is an initial anchor of 75 staff-months and then some more work was
  done and it really looks like the answer is more like 125 staff months.  What
...
* They shouldn't have been presenting such a precise number - instead a range or a
...
* An important part of a software developer we have to be able to speak truth
  to power.
* "Viewing estimate discussions as negotiations is a counter-productive way to
  view them.  In most business contexts we are not on the opposite of the
table.  We both want the product to be successful, we both want the customer
to be happy, we both want to be successful in the marketplace.  If we can
approach these as problem solving discussions that's a better mindset"
* As a technical leader your role in that discussion is to be the most
  knowledgable about the delivery capability of your team or your
organisation.  It is important for the sake of the organisation that you play
that role.  If you cut your estimate down the organisation has made a bad
decision on bad data.
* "I wish I could tell you there was some way we could deliver this for 75 but
  we've looked at this all different ways and we have come to the conclusion
that it really is going to be 125."
* "If this is a good idea at 75 and a bad idea at 125 then maybe it's a bad
  idea"
* Keep dragging the conversation back to "what is in the best interests of the
  organisation"
* People have a hard time defending estimates that they don't believe in.  The
  solution is better estimation skills.
* The business often probes until they find the point of weakness
* Developers often agree to the "nano probability schedule" - the shortest
  schedule that has a non-zero chance of coming true.  The business actually
want something you have confidence in.

## Resources

* ondemand.construx.com - On demand training videos for estimation,
  requirements, agile bootcamp
* youtube, books Steve McConnell
