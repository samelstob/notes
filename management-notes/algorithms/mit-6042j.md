...
Def: A pair of letteres L1 and L2 form an interverted pair if L1 precedes L2
in the alpahabet but L1 appears after L2 in the puzzle

If we start with an odd number of inverted pairs, we will always end with an
odd number of interverted pairs.
